...
# BEWARE! DO NOT EDIT THIS FILE! COPY THE CONFIGURE SECTION BELOW
# IE THE PART BETWEEN BEGIN AND END - AND ONLY THAT PART, NOTHING
# ELSE, INTO A jex.sh.user FILE, AND EDIT *THAT* FILE!

# --- BEGIN CONFIGURE BEGIN ---
...
export DOCKER_NETWORK= # the network name for our demo, if not default
...
export JOBBUILDER= # if not empty, include the job builder in builds
export SANDBOX_API=https://api.sandbox.viridian.hazelcast.cloud # Viridian sandbox API (e.g. https://...)
